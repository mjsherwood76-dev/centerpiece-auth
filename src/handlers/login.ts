 ...
 *   email, password, tenant, redirect, audience?, code_challenge?
 */
 ...
 *
 * Admin audience is set when:
 * - The redirect_uri points to an admin domain, OR
 * - The `audience=admin` query/form parameter is set
 */
